...
/**
 * ClassName:ZptMapInfoActivity Description：企业信息-编辑信息中公司地理位置
 * 
 * @author wujiahong Date：2012-10-25
 */
public class ZptMapDetailActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(R.layout.zpt_map_select);
		...
		backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ZptMapDetailActivity.this.finish();
			}
		});
