 ...
 * Date: 2012-9-4
 */
public class QztJobCommonActivity extends BaseActivity implements OnClickListener,OnScrollListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		listview.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
			{
				...
				Intent intent = new Intent(QztJobCommonActivity.this,QztJobDetailActivity.class);
	...
	private void onPostData() {
		AjaxCallBack<Object> callBack = new AjaxCallBack<Object>(this, false) {
			...
			public void onStart() {
				...
				proDialog = CustomeProgressDialog.createLoadingDialog(
						QztJobCommonActivity.this, "加载中,请稍后...");
				proDialog.show();
			}
		...
		qzzDAL.queryLytzList(user.getUserId(),pageNum,type, callBack);

	}

	private void postResult(String json) {
		returnList = DataConvert.toConvertObjectList(json, "sendings");
		addData();
	}
	...
	public void onClick(View v)
	{
		...
		{
		case R.id.backBtn:
			QztJobCommonActivity.this.finish();
			break;
