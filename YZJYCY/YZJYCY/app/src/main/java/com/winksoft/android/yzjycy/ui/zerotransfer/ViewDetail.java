...
public class ViewDetail extends BaseActivity {
    ...
    private String id, sfzStr, hzxmStr, ldlsStr, lxdhStr, bzStr;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        setContentView(R.layout.jcy_lzy_main_detail);
            ...
            public void onClick(View v) {
                new AsyncTask<Void, Void, ReJson>() {
                    ...
                    protected ReJson doInBackground(Void... params) {
                        ReJson json = dal.addZeroTransferDetail(sfzStr, hzxmStr, ldlsStr, lxdhStr, bzStr,
                                ViewDetail.this.user.getUserId(),
                                "",//ViewDetail.this.user.getOperatorname()
                                ViewDetail.this.user.getOrgid(),
                                "");//ViewDetail.this.user.getZzs051()  /*需要修改*/
                        return json;
                    }
