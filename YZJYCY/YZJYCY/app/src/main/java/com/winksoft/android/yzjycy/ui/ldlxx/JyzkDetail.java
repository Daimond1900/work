...
public class JyzkDetail extends BaseActivity {
    ...
    private String sfzStr, jbqcStr, jyztStr, mqjycyStr, cyhyStr, jyxsStr, sffxcyryStr, jydqlxStr, jydqStr, jyfsStr, wgnxStr, jnwgsjStr, wgygzStr, sfqdldhtStr, swzyryjyyxStr, sfjgbmStr;
...
//,,,,,,,,,,,,,,,
        ...
        jbqcStr = jbqc.getText().toString();
        jyztStr = jyzt.getText().toString();
        mqjycyStr = mqjycy.getText().toString();
        cyhyStr = cyhy.getText().toString();
        jyxsStr = jyxs.getText().toString();
        sffxcyryStr = sffxcyry.getText().toString();
        jydqlxStr = jydqlx.getText().toString();
        jydqStr = jydq.getText().toString();
        jyfsStr = jyfs.getText().toString();
        wgnxStr = wgnx.getText().toString();
        jnwgsjStr = jnwgsj.getText().toString();
        wgygzStr = wgygz.getText().toString();
        sfqdldhtStr = sfqdldht.getText().toString();
        swzyryjyyxStr = swzyryjyyx.getText().toString();
        sfjgbmStr = sfjgbm.getText().toString();
                ...
                if (cansave)
                    new AsyncTask<Void, Void, Boolean>() {
                        ...
                        protected Boolean doInBackground(Void... params) {
                            ...
                            // swzyryjyyx
                            //
                            ReJson json = dal.modifyEmploymentStatus(sfzStr,
                                    ParseData.getKeyByValue(ParseData.NCJBQK, jbqcStr),
                                    ParseData.getKeyByValue(ParseData.JYZT1, jyztStr),
                                    ParseData.getKeyByValue(ParseData.MQJYCY, mqjycyStr),
                                    ParseData.getKeyByValue(ParseData.CYHY, cyhyStr),
                                    ParseData.getKeyByValue(ParseData.JYXS, jyxsStr),
                                    ParseData.getKeyByValue(ParseData.TYSF, sffxcyryStr),
                                    ParseData.getKeyByValue(ParseData.JYDQXS, jydqlxStr),
                                    ParseData.getKeyByValue(ParseData.JYDQ, jydqStr),
                                    ParseData.getKeyByValue(ParseData.JYFS, jyfsStr),
                                    wgnxStr, jnwgsjStr, wgygzStr,
                                    ParseData.getKeyByValue(ParseData.TYSF, sfqdldhtStr),
                                    ParseData.getKeyByValue(ParseData.SWZYRYJYYX, swzyryjyyxStr),
                                    ParseData.getKeyByValue(ParseData.TYSF, sfjgbmStr),
