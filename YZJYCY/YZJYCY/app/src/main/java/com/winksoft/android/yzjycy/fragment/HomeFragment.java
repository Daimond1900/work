...
import com.winksoft.zgh.pagegridview.MyPageIndicator;
import com.winksoft.zgh.pagegridview.PageGridView;
...
//	private MyReceiver receiver;
	...
	private PageGridView pageGridView3;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initPageViewData();
		pageIndicator = (MyPageIndicator) layout.findViewById(R.id.pageindicator);
		width = getResources().getDisplayMetrics().widthPixels / 5;
		screenWidth = getResources().getDisplayMetrics().widthPixels;
		pageGridView3 = (PageGridView) layout.findViewById(R.id.pagingGridView3);
...
//		mainGv.setOnItemClickListener(this);
		...
		ivCyfw = layout.findViewById(R.id.ivCyfw);		// 创业服务
		ivCyfw.setOnClickListener(this);
		ivCydx = layout.findViewById(R.id.ivCydx);		// 创业典型
...
//		}
	...
	public class MyAdapter extends PageGridView.PagingAdapter<MyVH> implements PageGridView.OnItemClickListener {
		...
		public void onBindViewHolder(MyVH holder, int position) {
			if (mData.get(position).get("title") == null && "".equals(mData.get(position).get("title").toString())) {
...
//			}
		...
		//Toast.makeText(getContext(), gridview + " 第" + (position + 1) + "个item 被点击" + " 值：" + mData.get(position), Toast.LENGTH_SHORT).show();

			Intent in = null;
			switch (position) {
				case 0:
					in = new Intent(getContext(),Zpt_RegisterCountListActivity.class);
					startActivity(in);
					break;
	...
	private void initPageViewData() {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("title", "招聘信息");
		map.put("icon", R.drawable.jy_zpxx);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "就业热线");
		map.put("icon", R.drawable.jy_jyrx);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "创业咨询");
		map.put("icon", R.drawable.cy_pxjg);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "孵化基地");
		map.put("icon", R.drawable.cy_fhjd);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "指导专家");
		map.put("icon", R.drawable.cy_zdzj);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "政策法规");
		map.put("icon", R.drawable.zx_zcfg);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "就业新闻");
		map.put("icon", R.drawable.zx_jyxw);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "我的简历");
		map.put("icon", R.drawable.jy_wdjl);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "我的求职");
		map.put("icon", R.drawable.jy_wdqz);
		data.add(map);

		map = new HashMap<String, Object>();
		map.put("title", "培训信息");
		map.put("icon", R.drawable.jy_pxxx);
		data.add(map);
