...
public class PxyyDetail extends BaseActivity {
    ...
    private String sfzStr, sfcjgpxStr, jntcStr, gjzyzgStr, pxyyStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //,,,,
        pxyyStr = pxyy.getText().toString();
        sfzStr = sfz.getText().toString();
        sfcjgpxStr = sfcjgpx.getText().toString();
        jntcStr = jntc.getText().toString();
        gjzyzgStr = gjzyzg.getText().toString();
        ...
        save.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AsyncTask<Void, Void, Boolean>() {
                    // sfzStr,sfcjgpxStr,jntcStr,gjzyzgStr,pxyyStr
                    @Override
                    protected Boolean doInBackground(Void... params) {
                        ReJson json = dal.modifyTrainingAspiration(sfzStr,
                                ParseData.getKeyByValue(ParseData.TYSF, sfcjgpxStr),
                                jntcStr,
                                ParseData.getKeyByValue(ParseData.GJZYZG, gjzyzgStr),
                                ParseData.getKeyByValue(ParseData.PXYY, pxyyStr),
                                PxyyDetail.this.user.getUserId(), "", // PxyyDetail.this.user.getOperatorname()
                                PxyyDetail.this.user.getOrgid(), "");// PxyyDetail.this.user.getZzs051()
                        // 需要修改
                    ...
                    protected void onPreExecute() {
                        ...
                        progressDialog = PxyyDetail.this.commonUtil
                                .showProgressDialog(save.getText().toString() + "培训意愿中...");
    ...
    private String getAllString() {
        return sfz.getText().toString() + "," + name.getText().toString() + "," + sfcjgpx.getText().toString() + ","
                + jntc.getText().toString() + "," + gjzyzg.getText().toString() + "," + pxyy.getText().toString() + ","
    ...
    private void setButtonClisk(final TextView b, final String[] whcdvalue, final String title) {
        b.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(PxyyDetail.this).setTitle(title)
