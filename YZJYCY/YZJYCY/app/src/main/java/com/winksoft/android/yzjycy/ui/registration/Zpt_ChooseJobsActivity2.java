 ...
 *         Date：2012-10-19
 */
public class Zpt_ChooseJobsActivity2 extends BaseListActivity {
    ...
    protected BaseAdapter setAdapter() {
        adapter = new YFBaseAdapter(this, SURPERDATA, R.layout.zpt_recruitment_choose_jobs_list_item1_2,
        ...
        AjaxCallBack<Object> callBack = new AjaxCallBack<Object>(this, false) {
            ...
            public void onStart() {
                ...
                proDialog = CustomeProgressDialog.createLoadingDialog(
                        Zpt_ChooseJobsActivity2.this, "加载中,请稍后...");
                proDialog.show();
            }
