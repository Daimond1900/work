package com.winksoft.dropdownlayout;
...
import com.winksoft.dropdownlayout.ref.LQRDropdownButton;
import com.winksoft.dropdownlayout.ref.LQRDropdownItemObject;
import com.winksoft.dropdownlayout.ref.LQRDropdownListView;
...
public class LQRDropdownLayout extends FrameLayout {
    ...
    private int topHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 25.0f, getResources().getDisplayMetrics());
    ...
    public void init(View contentView, List<Map<String, String>> listData) {
        ...
        for (i = 0; i < cols; i++) {
            ...
            dropdownButton.setGravity(Gravity.RIGHT);   // 顶部显示按钮的位置
