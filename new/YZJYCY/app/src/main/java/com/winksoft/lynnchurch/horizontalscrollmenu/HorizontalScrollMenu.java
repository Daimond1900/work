package com.winksoft.lynnchurch.horizontalscrollmenu;
...
public class HorizontalScrollMenu extends LinearLayout
{
			...
			int defStyle)
	{
		...
		mColors = getResources().getColorStateList(
				R.drawable.new_selector_menu_item_text);
