...
import com.winksoft.android.yzjycy.ui.bminfo.Zpt_RegisterPostListActivity;
...
/**
 * ClassName:EmployCountListActivity
 * Description：录用查询-统计页面
 * @author Administrator
 * Date：2012-11-13
 */
public class Zpt_EmployCountListActivity extends BaseListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zpt_employ_count_list);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				try {
					...
					Intent intent = new Intent(Zpt_EmployCountListActivity.this, ZptEmployListActivity.class);
	...
	protected void loadDate() {
		AjaxCallBack<Object> callBack = new AjaxCallBack<Object>(this, false) {
			...
			public void onStart() {
				...
				proDialog = CustomeProgressDialog.createLoadingDialog(
						Zpt_EmployCountListActivity.this, "加载中,请稍后...");
				proDialog.show();
			}
		...
		qyDAL.doBmxxQuery(SUPERPAGENUM, "3", "", callBack);
	}
	...
	protected void formatData() {
		for (Map<String, String> tm : STRINGLIST) {
			...
			tm.put("itemPost", tm.get("acb216") !=null && !"".equals(tm.get("acb216")) ? tm.get("acb216"):"");// 岗位名称
			tm.put("itemNumber",tm.get("num") !=null && !"".equals(tm.get("num")) ? tm.get("num"):"");// 人数
	...
	private class MyClick implements OnClickListener {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.backBtn:
				Zpt_EmployCountListActivity.this.finish();
				break;
			default:
				break;
			}
