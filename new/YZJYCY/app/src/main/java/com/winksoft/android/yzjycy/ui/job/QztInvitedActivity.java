 ...
 * Date: 2012-9-4
 */
public class QztInvitedActivity extends BaseActivity implements OnClickListener,OnScrollListener
{
		...
		listview.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
			{
				try{
					...
					Intent intent = new Intent(QztInvitedActivity.this,QztJobDetailActivity.class);
...
//		new Thread(recRunnable).start();
	...
	private void onPostData() {
		AjaxCallBack<Object> callBack = new AjaxCallBack<Object>(this, false) {
			...
			public void onStart() {
				...
				proDialog = CustomeProgressDialog.createLoadingDialog(
						QztInvitedActivity.this, "加载中,请稍后...");
				proDialog.show();
			}
		...
		qzzDAL.queryLytzList(user.getUserId(), pageNum, "2", callBack);
	...
	public void onClick(View v)
	{
		...
		{
		case R.id.backBtn:
			QztInvitedActivity.this.finish();
			break;
