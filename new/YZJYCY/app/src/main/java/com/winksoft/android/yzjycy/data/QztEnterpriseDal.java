 ...
 * Date:2012-8-30
 */
public class QztEnterpriseDal extends BaseDAL {

	public QztEnterpriseDal(Context context) {
		super(context);
	}
	...
	public  List<Map<String,Object>> doPostQuery(String pageNum,String aab004,String aae017){
		...
		this.setUrl(Constants.IP +"android/corecruitment/listCompany");
	...
	public List<Map<String,String>> loadMaps(int myLat,int myLng,int limit,String positionName,String price){
		...
		this.setUrl(Constants.IP+"android/corecruitment/listCompanyAround");
		String json=this.doPost(params);
		
		List<Map<String,String>> list=DataConvert.toConvertStringList(json, "companies");
