 ...
 * Date: 2012-9-3
 */
public class NoticeActivity extends BaseActivity implements OnClickListener,OnScrollListener
{
		...
		listview.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
			{
				try{
					...
					Intent intent = new Intent(NoticeActivity.this,JobDetailActivity.class);
