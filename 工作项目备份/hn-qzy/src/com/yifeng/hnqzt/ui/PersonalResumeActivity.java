...
//		   	  mobile_num.setText(info.get("sj"));//手机号码
		      ...
		      work_area.setText(userDal.getPersonalAreas(info.get("gzdq")));//工作区域
...
//		      updateTime.setText(info.get("add_edit_date"));//修改时间
	...
	Runnable  runnable=new Runnable() {
		...
		public void run() {
			try{
				Thread.sleep(100);
				info=userDal.queryResumeDetail(user.getUserId(),"0");
	...
	private class ButtonClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.add_btn:
				Intent addIntent = new Intent(PersonalResumeActivity.this,AddResumeActivity.class);
				...
				break;
			case R.id.editBtn:
				Intent editBtn = new Intent(PersonalResumeActivity.this,AddResumeActivity.class);
				//addIntent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
