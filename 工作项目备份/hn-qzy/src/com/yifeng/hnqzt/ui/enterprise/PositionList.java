...
import com.yifeng.hnqzt.ui.recruit.PositionView;
...
public class PositionList extends BaseActivity implements OnScrollListener{
   ...
   @Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		enterDal=new EnterpriseDal(this);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
			   try{
					 Intent bl=new Intent(PositionList.this,PositionView.class);
   ...
   private void loadData()
	{
		if (pageNum == 0)
		{
			...
			adapter=new CommonAdapter(this, list, R.layout.position_list_item, new String[]{"positionDate","positionMoney","positionName","positionAddress"}, 
