...
public class AccountActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		checkbox.setChecked(user.isAutoLogin());
	...
	private  void checkPwd(){
		...
		else if(!user.getUserPwd().equals(oldPasswd)){
	...
	Runnable postRunnable=new Runnable() {
		...
		public void run() {
			try{
			   Thread.sleep(200);
			   returnMap=userDal.doUpdatePwd(user.getUserId(),user.getUserName(), oldPasswd, confirmPasswd);
