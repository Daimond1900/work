...
import com.yifeng.hnjcy.ui.ldlxx.IDCard;
...
public class TransferList extends BaseListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zero_transfer_list);
	...
	protected void setAdapter() {
		adapter = new MyBaseAdapter(this, SURPERDATA,
				R.layout.recruitment_list_item, new String[] { "hzxm",
	...
	protected List<Map<String, String>> setDataMethod() {
		...
		return dal.getListById(SUPERPAGENUM + "", this.user.getDepartmentid(),
				code.getText().toString()).getList();
	}
