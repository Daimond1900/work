...
public class YFListView extends ListView implements OnScrollListener {
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		// System.out.println(lastItem+"System.out.println(lastItem);");
		// System.out.println((a.getCount() - 1 -
		// count)+"(a.getCount() - 1 - count)");
		// System.out.println(scrollState+"scrollState");
		// 取出之前判断滚动状态，增加下拉刷新灵敏度
		if (lastItem == (a.getCount() - 1 - count)
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			progressBar.setVisibility(View.GONE);
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(R.drawable.zpt_head_arrow);
			tipsTextview.setText("下拉刷新");
			lastUpdatedTextView.setVisibility(View.VISIBLE);
