 ...
 */
public class EveryYearActivity extends BaseActivity implements
		OnScrollListener {
...
//	String itemString = "";// 上次点击item内容
	...
	void addData() {
		adapter.count +=1;
		List<Map<String, String>> returnList = dal.doQueryYearAll(pageNum + ""  );
		pageNum++;
...
//			Resources res = getResources();
	...
	private void doSetListView() {
		if (pageNum == 0) {
			list.clear();
			util.addFootBar();
			adapter = new HomeAdapter(this, list, R.layout.dbsx_item,
					new String[] {   "FILE_NAME"  }, new int[] 
					        {
			...
			listview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
						long arg3) {
//					UpdateList(arg2);
					if(arg2==list.size())return;
					Intent	intent = new Intent(EveryYearActivity.this,
					ForWebViewActivty.class);
			intent.putExtra("title_name", "年度总结");
			intent.putExtra("url","android/ndzj/doModify"+"?key="+user.getKey()+"&news_id="+list.get(arg2).get("NEWS_ID"));
