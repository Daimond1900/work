 ...
 */
public class EveryMonthActivity extends BaseActivity implements
		OnScrollListener {
...
//	String itemString = "";// 上次点击item内容
	...
	void addData() {
		adapter.count +=1;
		List<Map<String, String>> returnList = dal.doQueryMonthAll(pageNum + "","android/myjb/doInit"  );
		pageNum++;
...
//					UpdateList(arg2);
			...
			intent.putExtra("url","android/myjb/doModify"+"?key="+user.getKey()+"&news_id="+list.get(arg2).get("NEWS_ID"));
