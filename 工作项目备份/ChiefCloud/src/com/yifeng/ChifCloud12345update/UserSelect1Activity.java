...
public class UserSelect1Activity extends BaseActivity implements OnClickListener,OnScrollListener {
	...
	public void loadData() {
		...
		departments = findUserData.listDepartment(org_id);
	...
	private boolean addAssign() {
		...
		if (!userid.equals("")) {
			String state = dal.doAddAssign(form_id, LoginBiz.loadUser(this).getUserId(),
					editText1.getText().toString(), userid, LoginBiz
	...
	public void onClick(View arg0) {
		...
		case R.id.submit:
			...
			break;
		case R.id.cancle:
			UserSelect1Activity.this.finish();
			break;
		}
	}
String deptId="";
	...
	class GetUserByDept extends AsyncTask<String, Integer, Void> {
		...
		protected void onPreExecute() {
			pd = new ProgressDialog(UserSelect1Activity.this);
