...
public class NotWorkOrderAdapter extends SimpleAdapter {
	...
	public NotWorkOrderAdapter(Context context, List<Map<String, Object>> data,
				...
				public void onClick(View v) {
					...
					if (icon1.getText().equals("关注工单")) {
						...
						if (role_type != null) {
							...
							NotWorkOrderAdapter.this.notifyDataSetChanged();
						}
