...
//	private static final String DATABASE_PATH = Environment.getExternalStorageDirectory() + "/ylk/";
	...
	private static final int VERSION = 5;// 数据库版本 ,如果修改表结构版本要比原来高
	...
	// 签到
	private static final String sign = "create table if not exists signin (" +
			"id integer primary key autoincrement, " +
			"sign_no varchar(10)," + //签到工号
			"signin_date varchar(20)," +  //签到时间
			"signout_date varchar(20)," +  //签退时间
			"state varchar(1)," + //签到状态   0:签到,1:签退
			"transaction_date varchar(20),"+
			"daypay_date varchar(20),"+
			"psam1 varchar(20),"+
			"psam2 varchar(20),"+
			"money varchar(50),"+
			"pay_count varchar(50)"+
			");";
	
	// 工号管理
	private static final String employee = "CREATE TABLE  IF NOT EXISTS employee(id integer PRIMARY KEY autoincrement, "
