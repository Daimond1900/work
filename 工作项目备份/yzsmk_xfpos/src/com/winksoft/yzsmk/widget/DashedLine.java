...
public class DashedLine extends View {
	...
	public DashedLine(Context paramContext, AttributeSet paramAttributeSet) {
		...
		this.paint.setStrokeWidth(UiUtils.dipToPx(getContext(), 2.0F));
		float[] arrayOfFloat = new float[4];
		arrayOfFloat[0] = UiUtils.dipToPx(getContext(), 2.0F);
		arrayOfFloat[1] = UiUtils.dipToPx(getContext(), 2.0F);
		arrayOfFloat[2] = UiUtils.dipToPx(getContext(), 2.0F);
		arrayOfFloat[3] = UiUtils.dipToPx(getContext(), 2.0F);
		this.pe = new DashPathEffect(arrayOfFloat, UiUtils.dipToPx(
				getContext(), 1.0F));
	}
