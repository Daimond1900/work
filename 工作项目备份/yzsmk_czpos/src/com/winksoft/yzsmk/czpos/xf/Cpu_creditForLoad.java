...
public class Cpu_creditForLoad extends MainActivity {
	...
	/*
	 * + "CorpId varchar(11)," //+ "TxnFileName varchar(27)," +
	 * "SettDate varchar(8)," + "CitizenCardNo varchar(20)," +
	 * "CrdBalBef varchar(14)," + "CrdBalAft varchar(14)," +
	 * "TxnAmt  varchar(14)," + "TxnDt varchar(14)," + "SamNo varchar(12)," +
	 * "AccpetCusNo 	varchar(20)," + "OprNo varchar(24)," + "TAC varchar(8),"
	 * + "BusinessNo 	 varchar(10)," + "CurrCount	varchar(8)," +
