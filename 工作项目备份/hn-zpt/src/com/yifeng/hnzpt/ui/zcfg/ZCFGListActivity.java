package com.yifeng.hnzpt.ui.zcfg;
...
/**
 * ClassName:ZCFGListActivity Description：政策法规-列表
 * 
 * @author Administrator Date：2013-02-26
 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				try {
					Intent intent = new Intent(ZCFGListActivity.this,
							ZCFGDeatilActivity.class);
					// String
					...
					bundle.putString("url", ConstantUtil.ip
