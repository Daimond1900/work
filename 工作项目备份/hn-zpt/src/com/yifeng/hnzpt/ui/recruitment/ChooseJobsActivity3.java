...
import com.yifeng.hnzpt.adapter.MyCheckBoxAdapter;
import com.yifeng.hnzpt.adapter.MyCheckBoxAdapter.ViewHolder;
 ...
 * Date：2012-10-20
 */
public class ChooseJobsActivity3 extends BaseActivity implements OnScrollListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		backBtn.setOnClickListener(new OnClickListener()
		{
			...
			{
				ChooseJobsActivity3.this.finish();
			}
		});
		...
		listview.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
			{
				...
				try
				{
					...
					Intent intent = new Intent(ChooseJobsActivity3.this, RecruitmentActivity.class);
	...
	private void doLoadData()
	{
		if (pageNum == 0)
		{
			...
			adapter = new MyCheckBoxAdapter(this, list, R.layout.recruitment_choose_jobs_list_item2, 
