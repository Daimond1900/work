...
public class AsyncImageLoader {
	...
	public synchronized Drawable loadDrawable(final String imageUrl, final ImageCallback imageCallback, final String tag) {
		commonUtil = new CommonUtil(context, activity);
