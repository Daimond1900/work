package com.yifeng.hnjcy.ui.zerotransfer;
...
import com.yifeng.hnjcy.data.ZeroTransferDAL;
...
public class TansferDetail extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lzy_main_edit);
			...
			public void onClick(View v) {
				new AsyncTask<Void, Void, Boolean>() {
					...
					protected Boolean doInBackground(Void... params) {
						ReJson json = dal.modifyZeroTransferDetail(id,sfz.getText().toString(),
								hzxm.getText().toString(), ldls.getText().toString(), lxdh.getText().toString(), bz.getText().toString(),
								TansferDetail.this.user.getUserid(),
								TansferDetail.this.user.getOperatorname(),
								TansferDetail.this.user.getOrg(),
