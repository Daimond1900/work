...
/**
 * Android AutoUpdate. 吴家宏/2011.04.11 
 * 1.Set apkUrl. 2.check(). 3.add delFile()
...
public class AutoUpdate {
	...
	private void showDownloadDialog() {
		...
		Button cancel_btn = (Button) mDownloadDialog.findViewById(R.id.cancel_btn);
		cancel_btn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
	...
	private void doDownloadTheFile(String strPath) throws Exception {
		...
		if (!URLUtil.isNetworkUrl(strPath)) {
			...
			// fileEx);//下载到sdcard
			myTempFile = new File("data/data/"+ConstantUtil.SYS_PACK_NAME, fileNa + "." + fileEx);// 下载到内存
			// String
