 ...
 * Date：2012-11-13
 */
public class EmployCountListActivity extends BaseActivity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.employ_count_list);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				try {
					...
					Intent intent = new Intent(EmployCountListActivity.this, EmployListActivity.class);
	...
	private class MyClick implements OnClickListener {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.backBtn:
				EmployCountListActivity.this.finish();
				break;
