 ...
 * Date：2012-10-19
 */
public class ChooseJobsActivity2 extends BaseActivity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ChooseJobsActivity2.this.finish();
			}
		});
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				try {
					if(list.size() > 0){
						...
						Intent intent = new Intent(ChooseJobsActivity2.this, ChooseJobsActivity4.class);
	...
	private void doLoadData() {
		...
		if (pageNum == 0) {
			...
			util.removeFootBar();
			util.addFootBar();
			adapter = new CommonAdapter(this, list, R.layout.recruitment_choose_jobs_list_item1_2, 
