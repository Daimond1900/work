...
/**
 * ClassName:RegisterPostListActivity 
 * Description：报名信息-岗位的报名情况
 * @author Administrator 
 * Date：2012-10-22
 */
public class RegisterPostListActivity extends BaseActivity implements OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.register_post_list);
		...
		qbBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button));
		...
		ytzBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button_));
		...
		yjjBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button_));
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				try {
					Intent intent = new Intent(RegisterPostListActivity.this, PersonalResumeActivity.class);
	...
	private void doLoadData() {
		if (pageNum == 0) {
			...
			util.removeFootBar();
			util.addFootBar();
			adapter = new CommonAdapter(this, list, R.layout.register_post_list_item1, 
					new String[] { "itemName", "itemSex", "itemTag", "itemContact", "itemDate" }, 
					new int[] { R.id.item_nameTxt, R.id.item_sexTxt, R.id.item_tagTxt, R.id.item_contactTxt, R.id.item_dateTxt }, getResources());
			if(flag.equals("")){
	...
	private class MyClick implements OnClickListener {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.backBtn:
				RegisterPostListActivity.this.finish();
				break;
			case R.id.qbBtn:
				flag = "";
				qbBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button));
			...
			case R.id.ytzBtn:
				flag = "2";
				qbBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button_));
				qbBtn.setTextColor(getResources().getColor(R.color.register_tab_button_font_));
				ytzBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button));
			...
			case R.id.yjjBtn:
				...
				ytzBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button_));
				ytzBtn.setTextColor(getResources().getColor(R.color.register_tab_button_font_));
				yjjBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.register_tab_button));
