...
public class PersonalResumeActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.register_personal_resume);
...
//			mobile_num.setText(returnMap.get("sj"));// 手机号码
	...
	private void showAgreeDialog(String title) {
		final Dialog builder = new Dialog(PersonalResumeActivity.this, R.style.dialog);
		builder.setContentView(R.layout.register_input_dialog_agree);
	...
	private void showRefuseDialog(String title, final String content1) {
		final Dialog builder = new Dialog(PersonalResumeActivity.this, R.style.dialog);
		builder.setContentView(R.layout.register_input_dialog_refuse);
		TextView titleTxt = (TextView) builder.findViewById(R.id.titleTxt);
		titleTxt.setText(title);
