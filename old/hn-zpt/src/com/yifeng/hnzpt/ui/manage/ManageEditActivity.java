 ...
 */
public class ManageEditActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.manage_edit);
	...
	private void showMsg(String title, String msg,final boolean success) {
		final Dialog builder = new Dialog(ManageEditActivity.this,
				R.style.dialog);
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				builder.dismiss();
				if(success){
//					Intent intent = new Intent(ManageEditActivity.this,ManageListActivity.class);
