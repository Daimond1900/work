...
import com.yifeng.hnzpt.ui.mapabc.MapInfoActivity;
...
public class EnterpriseActivity extends BaseActivity {
	...
	private void initView() {
		...
		gsTxt.setText(user.getCompanyName());
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.backBtn:
				Intent intent1 = new Intent(EnterpriseActivity.this,MainMenuActivity.class);
				startActivity(intent1);
				EnterpriseActivity.this.finish();
				
				break;
			case R.id.editBtn:
				Intent intent2 = new Intent(EnterpriseActivity.this, EnterpriseEditActivity.class);
				userSession.setMaps(gsTxt.getText().toString(), dzTxt.getText().toString(), dhTxt.getText().toString());
				startActivity(intent2);
				break;
			case R.id.addressTab:
				if (!longitude.equals("") && !latitude.equals("")) {
					Intent map = new Intent(EnterpriseActivity.this, MapInfoActivity.class);
					...
					dialogUtil.shortToast(user.getCompanyName() + ",还没标注地理位置.");
				}
				break;
			default:
				break;
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 2) {
				...
				if (logoBamp != null) {
					...
					logoBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.company_logo));
				}
			}
