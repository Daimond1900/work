 ...
 * comment:WebView操作父类
 * 
 * @author:ZhangYan Date:2012-8-20
 */
public class BaseWebView extends BaseActivity {
	...
	protected void showProg() {
		// progressDialog = ProgressDialog.show(this, "请稍等...", "数据加载中...",
		// true);
		/*
	...
	public void synCookies(Context context, String url) {
		...
		SharedPreferences cookies = BaseWebView.this.getSharedPreferences("COOKIES", 0);
