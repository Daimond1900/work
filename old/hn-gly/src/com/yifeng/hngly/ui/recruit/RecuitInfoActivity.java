...
import com.yifeng.hngly.data.RecuitDal;
		...
		OnScrollListener
   {
		...
		listview.setOnItemClickListener(new OnItemClickListener()
		{
					...
					long arg3)
			{
				try
				{
					...
					Intent intent = new Intent(RecuitInfoActivity.this,PositionView.class);
	...
	private void doLoadData()
	{
		if (pageNum == 0)
		{
			...
			adapter = new CommonAdapter(this, list, R.layout.recruitment_list_item, 
