...
//	public static final String ip = "http://124.225.113.8:8421/hnjyy/";
	public static final String ip = "http://192.168.66.105:8080/hnjy/";
	
 	/**是否登陆*/
    public static boolean IFLOGIN=false;
	/**自动更新放到内存*/
	public static final String SYS_PACK_NAME = "com.yifeng.hngly.ui"; 
	public static final String downapk=ip+"download/hngly.apk";
	public static final String downtxt=ip+"download/hngly.txt";
	//标志是否是管理版进来的 默认为false
	public static boolean ISEJOB=false;
	//程序互调密钥
	public static final String AUTH_KEY="EJOB2012";
	public static final String IMAGE_CAPTURE = Environment.getExternalStorageDirectory()+"/hngly";
