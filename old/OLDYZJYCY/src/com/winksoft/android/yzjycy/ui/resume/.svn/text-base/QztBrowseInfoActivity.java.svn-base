...
import com.winksoft.android.yzjycy.adapter.HomeAdapter;
import com.winksoft.android.yzjycy.data.BrowseDAL;
 ...
 */
public class QztBrowseInfoActivity extends BaseActivity implements
		OnScrollListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.qzt_browse_org_info);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(id != null && !id.equals("")){
					Intent intent = new Intent(QztBrowseInfoActivity.this,QztCompanyDetailActivity.class);
	...
	private void doSetListView() {
		if (pageNum == 0) {
			...
			adapter = new HomeAdapter(this, list,
					R.layout.qzt_browse_org_info_item, new String[] { "id",
