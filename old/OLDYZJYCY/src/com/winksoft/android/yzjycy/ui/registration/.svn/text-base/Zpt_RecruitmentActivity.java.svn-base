...
//		if (tag.equals("Zpt_ChooseJobsActivity4")) {
...
//				Intent intent1 = new Intent(Zpt_RecruitmentActivity.this,MenuActivity.class);
...
//				params.add(new BasicNameValuePair("acb200", "4028808a497da1ff01497f032ece001c"));// 单位编号
				params.add(new BasicNameValuePair("acb200", user.getUserId()));// 单位编号
				params.add(new BasicNameValuePair("aca112", job));// 招聘岗位
				params.add(new BasicNameValuePair("aca111", getIntent().getStringExtra("aca111")));//工作岗位ID
				params.add(new BasicNameValuePair("acb216", gzsm));//工作说明
				...
				params.add(new BasicNameValuePair("aae017", user.getArea_id())); //单位所在地区编号
