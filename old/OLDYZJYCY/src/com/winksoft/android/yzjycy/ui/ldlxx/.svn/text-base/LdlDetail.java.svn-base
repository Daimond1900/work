				...
				if (cansave)
					new AsyncTask<Void, Void, Boolean>() {
						...
						protected Boolean doInBackground(Void... params) {
							...
							// jyzt;
							return dal
									.modifyLabourInfo(sfz.getText().toString(), name.getText().toString(),
											...
											ParseData.getKeyByValue(ParseData.HKZT, hkxz.getText().toString()),
											ParseData.getKeyByValue(ParseData.WHCD, whcd.getText().toString()),
											jtzz.getText().toString(), user.getUserId(), "", // user.getOperatorname()
