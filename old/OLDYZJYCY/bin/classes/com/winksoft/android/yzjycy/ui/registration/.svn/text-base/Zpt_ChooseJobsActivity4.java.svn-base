 ...
 * Date：2012-10-20
 */
public class Zpt_ChooseJobsActivity4 extends BaseActivity implements OnScrollListener {
	...
	private void doLoadData() {
		if (pageNum == 0) {
			...
			util.removeFootBar();
			util.addFootBar();
			adapter = new CommonAdapter(this, list, R.layout.zpt_recruitment_choose_jobs_list_item1_3, 
