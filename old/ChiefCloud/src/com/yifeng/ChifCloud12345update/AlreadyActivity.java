...
import com.yifeng.adapter.AlreadyAdapter;
import com.yifeng.data.FormDAL;
import com.yifeng.util.ConstantUtil;
import com.yifeng.util.DateUtil;

public class AlreadyActivity extends BaseActivity implements
OnScrollListener{
	ListView listview;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.yibanjie);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(AlreadyActivity.this,
		...
		doSetListView();
		this.initTabs();
		this.setTabsFocus(this.tabs_menu3, R.drawable.menubg);
		initCount();
		this.initBottom();
	...
	public  void doSetListView() {
		if (pageNum == 0) {
			list.clear();
			addFootBar();
			adapter = new AlreadyAdapter(this, list, R.layout.gdzp_ybj_item,
	...
	Handler jobHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			Intent serverIntent = new Intent(AlreadyActivity.this,
	...
	void addData() {
		...
		List<Map<String, String>> returnList = dal.doQueryForms(param,"android/dispatch/doAlreadyOverList");
		pageNum++;
