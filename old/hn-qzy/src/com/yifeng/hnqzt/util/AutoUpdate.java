...
public class AutoUpdate {
	...
	private void showDownloadDialog() {
		...
		final TextView ptitle = (TextView) mDownloadDialog.findViewById(R.id.pTitle);
		ptitle.setText("版本更新");
		...
		final Button confirm_btn = (Button) mDownloadDialog.findViewById(R.id.confirm_btn);//确定更新
		confirm_btn.setOnClickListener(new OnClickListener() {
