...
public class StringHelper {
	...
	/***
	 * 经度转换 11918617 转成119.18617
	 * @param longitude
	 * @return
	 */
	public static String getStringLongitude(String longitude){
		String lng="0";
		try{
		 if(longitude.length()>3){
			 lng=longitude.substring(0,3)+"."+longitude.substring(3);
    ...
    /***
	 * 纬度转换 3226327 转成32.26327
	 * @param latitude
	 * @return
	 */
    public static String getStringLatitude(String latitude){
    	String lng="0";
    	try{
		 if(latitude.length()>2){
			 lng=latitude.substring(0,2)+"."+latitude.substring(2);
