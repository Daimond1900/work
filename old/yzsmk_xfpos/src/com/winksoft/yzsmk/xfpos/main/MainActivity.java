package com.winksoft.yzsmk.xfpos.main;
...
import com.winksoft.yzsmk.xfpos.balance.SelectBalanceActivity;
import com.winksoft.yzsmk.xfpos.base.BaseActivity;
import com.winksoft.yzsmk.xfpos.consumerecord.ConsumptionList;
import com.winksoft.yzsmk.xfpos.employee.EmployeeActivity;
import com.winksoft.yzsmk.xfpos.queryvalue.QueryValues;
import com.winksoft.yzsmk.xfpos.settingparam.SettingActivity;
import com.winksoft.yzsmk.xfpos.signout.SignOutActivity;
import com.winksoft.yzsmk.xfpos.xf.PayActivity;
	...
	private void initMenu() {
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				// 交易记录
				case 2:
					Intent consumptionList = new Intent(MainActivity.this, ConsumptionList.class);
				...
				case 5:
					...
					if (file != null) {
						...
						QueryValues qv = new QueryValues(1);
						...
						intent.putExtra("desfireIp", qv.getDesfireIP());
						intent.putExtra("desfirePort", qv.getDesfirePort());
					}
				...
				case 7: // 签退
					// 下午修改
					int isSign1 = sqliteUtil.doQuery("select count(1) from signin where state = '0'");
					if (isSign1 == 0) {
						showSignDialog();
						return;
					}
