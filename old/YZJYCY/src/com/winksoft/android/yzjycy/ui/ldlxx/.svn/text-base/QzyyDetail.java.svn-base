			...
			public void onClick(View v) {
				new AsyncTask<Void, Void, Boolean>() {
					...
					protected Boolean doInBackground(Void... params) {
						ReJson json = dal.modifyJobAspiration(sfz.getText().toString(), qzgz.getText().toString(),
								ParseData.getKeyByValue(ParseData.JYDQXS, qzdq.getText().toString()),
								yxgzjw.getText().toString(), QzyyDetail.this.user.getUserId(), "", // QzyyDetail.this.user.getOperatorname()
																									// 需要修改
