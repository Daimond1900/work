				...
				new AsyncTask<Void, Void, Boolean>() {
					...
					protected Boolean doInBackground(Void... params) {
						ReJson json = dal.modifyTrainingAspiration(sfz.getText().toString(),
								ParseData.getKeyByValue(ParseData.TYSF, sfcjgpx.getText().toString()),
								jntc.getText().toString(),
								ParseData.getKeyByValue(ParseData.GJZYZG, gjzyzg.getText().toString()),
								ParseData.getKeyByValue(ParseData.PXYY, pxyy.getText().toString()),
