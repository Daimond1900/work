 ...
 * Date：2012-11-13
 */
public class Zpt_EmployCountListActivity extends BaseActivity implements OnScrollListener {
	...
	private void doLoadData() {
		if (pageNum == 0) {
			list.clear();
			util.addFootBar();
			adapter = new CommonAdapter(this, list, R.layout.zpt_register_count_list_item, 
