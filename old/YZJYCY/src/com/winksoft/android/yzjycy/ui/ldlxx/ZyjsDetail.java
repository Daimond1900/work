			...
			public void onClick(View v) {
				new AsyncTask<Void, Void, Boolean>() {
					...
					protected Boolean doInBackground(Void... params) {
						ReJson json = dal.modifyResourceReduction(sfz.getText().toString(),
								ParseData.getKeyByValue(ParseData.JSYY, jsyy.getText().toString()),
								bzsm.getText().toString(), ZyjsDetail.this.user.getUserId(), "", // ZyjsDetail.this.user.getOperatorname()
																									// 需要修改
