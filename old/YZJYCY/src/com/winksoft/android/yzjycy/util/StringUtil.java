...
public class StringUtil {
	 ...
	 * @throws
	 */
	public static boolean contains(String parameter, String[] strs) {
		for (String str : strs) {
	 ...
	 * @Description: 字符串长度是否在指定范围（-1为无要求）
	 * @param @param parameter
	 ...
	 * @throws
	 */
	public static boolean validateLength(String parameter, int maxLength,
			int minLength) {
	 ...
	 * @throws
	 */
	public static boolean containsCNChars(String parameter) {
		String regEx = "[\\u4e00-\\u9fa5]";
	...
	public static boolean isMobileNo(String mobileNo) {
		 ...
		 */
		Pattern p = Pattern
				.compile("^((13[0-9])|(1[5,8][^4,\\D])|(14[5,7]))\\d{8}$");
		Matcher m = p.matcher(mobileNo);
		return m.matches();
	}

	/** 
	* @Title: isFixedLinePhone 
	* @Description: 验证是否是合法的固话号码，形式如051487908228
	* @param @param telNo
	* @param @return    设定文件 
	* @return boolean    返回类型 
	* @throws 
	*/
	public static boolean isFixedLineNo(String telNo) {
