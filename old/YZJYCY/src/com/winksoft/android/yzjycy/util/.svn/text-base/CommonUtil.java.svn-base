...
//		int day = c.get(Calendar.DATE);
	...
	public LinearLayout  addFootBar() {
		...
		View searchLayout = inflater.inflate(R.layout.qzt_publicloadingprogress, null);
	...
	public void alertNetError() {
		...
		dialog.setContentView(R.layout.jcy_network_set);
		final Button update = (Button)dialog.findViewById(R.id.update);
		update.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				dialog.dismiss();
				activity.startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));//网络设置
			}
		});
